...
(function($) {
	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch( type ) {
				case 'alert':
					$("#popup_message").after('<div id="popup_panel"><input type="button" class="button small" value="' + $.alerts.okButton + '" id="popup_ok" /></div>');
				...
				break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><input type="button" class="button small"  value="' + $.alerts.okButton + '" id="popup_ok" /> <input type="button" class="button small"  value="' + $.alerts.cancelButton + '" id="popup_cancel" /></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
